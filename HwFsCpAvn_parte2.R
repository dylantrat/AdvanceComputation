...
#########################################################
#########################################################
#D.Fecha de MJD (Modified Julian Day) en tiempo POSIX (GMT)
...
###########################################################
###########################################################
#E.Agregar una columna de tiempo GMT
...
icecube = Add_GMT(icecube)
#############################################################
#############################################################
#F.Cantidad de eventos por mes 
...
###############################################################
###############################################################
#G.Grafico de distribucion de eventos en coordenadas ecuatoriales
x_ev = c()
y_ev = c()
n = nrow(icecube)
for (q in 1:n)
...
plot(y_ev,x_ev,main="Events on Equatorial Coordinates", xlab="Right ascension", ylab = "Declination")
########################################################################
########################################################################
#H.Funcion independiente - Best fit power flux
#PRL 113, 101101 (2014) - Observation of High-Energy Astrophysical 
#Neutrinos in Three Years of IceCube Data
#Page 5, Fig 4.
